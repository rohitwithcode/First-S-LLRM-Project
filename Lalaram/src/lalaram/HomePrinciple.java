...
public class HomePrinciple extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HomePrinciple frame = new HomePrinciple();
	...
	public HomePrinciple() {
		...
		JMenuItem mntmNewFaculty = new JMenuItem("New Faculty");
		mntmNewFaculty.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F, InputEvent.CTRL_DOWN_MASK | InputEvent.SHIFT_DOWN_MASK));
		mntmNewFaculty.addActionListener(this);
		mntmNewFaculty.setForeground(new Color(0, 0, 51));
		mntmNewFaculty.setBackground(Color.WHITE);
		mntmNewFaculty.setFont(new Font("Segoe UI", Font.BOLD, 12));
		menuNewInformation.add(mntmNewFaculty);
		...
		JMenuItem mntmViewFaculty = new JMenuItem("View Faculty");
		mntmViewFaculty.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F, InputEvent.CTRL_DOWN_MASK));
		mntmViewFaculty.addActionListener(this);
		mntmViewFaculty.setForeground(new Color(0, 255, 153));
		mntmViewFaculty.setBackground(new Color(255, 255, 255));
		mntmViewFaculty.setFont(new Font("Segoe UI", Font.BOLD, 12));
		menuViewInformation.add(mntmViewFaculty);
		...
		JMenuItem mntmUpdateFaculty = new JMenuItem("update faculty");
		mntmUpdateFaculty.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_U, InputEvent.CTRL_DOWN_MASK));
		mntmUpdateFaculty.addActionListener(this);
		mntmUpdateFaculty.setForeground(new Color(0, 206, 209));
		mntmUpdateFaculty.setFont(new Font("Segoe UI", Font.BOLD, 12));
		mntmUpdateFaculty.setBackground(Color.WHITE);
		menuUpdateInformation.add(mntmUpdateFaculty);
		...
		JMenuItem mntmDeleteFaculty = new JMenuItem("delete faculty");
		mntmDeleteFaculty.addActionListener(this);
		mntmDeleteFaculty.setForeground(new Color(255, 255, 0));
		mntmDeleteFaculty.setFont(new Font("Segoe UI", Font.BOLD, 12));
		mntmDeleteFaculty.setBackground(Color.WHITE);
		menuDeleteInformation.add(mntmDeleteFaculty);
		...
		JMenuItem mntmLeaveFaculty = new JMenuItem("leave faculty");
		mntmLeaveFaculty.addActionListener(this);
		mntmLeaveFaculty.setForeground(new Color(153, 204, 0));
		mntmLeaveFaculty.setFont(new Font("Segoe UI", Font.BOLD, 12));
		mntmLeaveFaculty.setBackground(Color.WHITE);
		menuLeave.add(mntmLeaveFaculty);
		...
		JMenuItem mntmViewFacultyLeave = new JMenuItem("view faculty leave");
		mntmViewFacultyLeave.addActionListener(this);
		mntmViewFacultyLeave.setForeground(new Color(255, 51, 255));
		mntmViewFacultyLeave.setFont(new Font("Segoe UI", Font.BOLD, 12));
		mntmViewFacultyLeave.setBackground(Color.WHITE);
		menuLeaveDetails.add(mntmViewFacultyLeave);
